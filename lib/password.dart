                ...
                children: [Container(
                    margin: const EdgeInsets.only(top: 70),
                      child: const Center(
                        child:Column(
                          children: [
                            Text("Verify your Email address ",style: TextStyle(fontSize: 22,),),
                            Text("Hey, have You Received!",style: TextStyle(fontSize: 22,),),
                    ])
                      )),
                  Container(
                    height: 350,
                    width: 350,
                    child: Center(
                    child:Image.asset('assets/images/Enter OTP-rafiki.png'),
                    )
                  )]
            )
              ),
                    ...
                    child: Column(
                      children: [
                        Container(
                            ...
                            child :Center(
                              child:Text("Enter One Time OTP",style: TextStyle(fontSize: 16,),),)
                        ),
                        Center(
                        child: Container(
                        ...
                        Container(
                          ...
                          child :Center(
                                child:Column(
                                children: [
                                  Text("Please, Enter your six digit code that you have received in",style: TextStyle(fontSize: 12,),),
                                  Text("your mail box. Resend OTP",style: TextStyle(fontSize: 12,),),
                            ])
                          )),
